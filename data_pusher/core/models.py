...
class Webhook(models.Model):
    account = models.ForeignKey(Account, related_name='webhooks', on_delete=models.CASCADE)
    event = models.CharField(max_length=50)
    destination = models.ForeignKey(Destination, related_name='webhooks', on_delete=models.CASCADE)
